...
public class RfidConnect extends ReactContextBaseJavaModule {
    ...
    //Constructor
    public RfidConnect(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    //Đăng ký tên native module
    @NonNull
    @Override
    public String getName() {
        return "RfidAndroidNative";
    }
